...
extension BAMify {
	open class PrefixResponseQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = PrefixResponse

		@discardableResult
		open func meta(aliasSuffix: String? = nil, _ subfields: (SearchResponseMetaQuery) -> Void) -> PrefixResponseQuery {
		...
		@discardableResult
		open func query(aliasSuffix: String? = nil) -> PrefixResponseQuery {
			addField(field: "query", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func entities(aliasSuffix: String? = nil) -> PrefixResponseQuery {
			addField(field: "entities", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func facets(aliasSuffix: String? = nil, _ subfields: (SearchResponseFacetQuery) -> Void) -> PrefixResponseQuery {
		...
		@discardableResult
		open func hits(aliasSuffix: String? = nil, _ subfields: (SearchHitQuery) -> Void) -> PrefixResponseQuery {
		...
		@discardableResult
		open func user(aliasSuffix: String? = nil, _ subfields: (UserQuery) -> Void) -> PrefixResponseQuery {
	...
	open class PrefixResponse: GraphQL.AbstractResponse, GraphQLObject, SearchResponse {
		public typealias Query = PrefixResponseQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [String: Any] else {
					throw SchemaViolationError(type: PrefixResponse.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "PrefixResponse" }
