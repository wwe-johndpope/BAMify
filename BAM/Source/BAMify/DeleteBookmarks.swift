...
extension BAMify {
	open class DeleteBookmarksQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = DeleteBookmarks

		@discardableResult
		open func bookmarks(aliasSuffix: String? = nil, _ subfields: (DeletedBookmarkQuery) -> Void) -> DeleteBookmarksQuery {
		...
		@discardableResult
		open func meta(aliasSuffix: String? = nil, _ subfields: (MetaDeletionQuery) -> Void) -> DeleteBookmarksQuery {
	...
	open class DeleteBookmarks: GraphQL.AbstractResponse, GraphQLObject {
		public typealias Query = DeleteBookmarksQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? [Any] else {
					throw SchemaViolationError(type: DeleteBookmarks.self, field: fieldName, value: fieldValue)
				}
		...
		open var typeName: String { return "DeleteBookmarks" }
