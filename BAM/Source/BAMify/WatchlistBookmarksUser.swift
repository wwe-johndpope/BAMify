...
extension BAMify {
	open class WatchlistBookmarksUserQuery: GraphQL.AbstractQuery, GraphQLQuery {
		public typealias Response = WatchlistBookmarksUser

		@discardableResult
		open func onWatchlist(aliasSuffix: String? = nil) -> WatchlistBookmarksUserQuery {
			addField(field: "onWatchlist", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func lastWatched(aliasSuffix: String? = nil) -> WatchlistBookmarksUserQuery {
			addField(field: "lastWatched", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func percentCompleted(aliasSuffix: String? = nil) -> WatchlistBookmarksUserQuery {
			addField(field: "percentCompleted", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func secondsWatched(aliasSuffix: String? = nil) -> WatchlistBookmarksUserQuery {
			addField(field: "secondsWatched", aliasSuffix: aliasSuffix)
			return self
		}
	}

	open class WatchlistBookmarksUser: GraphQL.AbstractResponse, GraphQLObject, WatchlistMethods {
		public typealias Query = WatchlistBookmarksUserQuery
		...
		open override func deserializeValue(fieldName: String, value: Any) throws -> Any? {
			...
			switch fieldName {
				...
				guard let value = value as? Bool else {
					throw SchemaViolationError(type: WatchlistBookmarksUser.self, field: fieldName, value: fieldValue)
				}
				return value
		...
		open var typeName: String { return "WatchlistBookmarksUser" }
